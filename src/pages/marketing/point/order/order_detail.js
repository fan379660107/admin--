...
export default class Order_detail extends Component {
  ...
  render() {
    const {
      order_detail, invoice_info, receiver_info, order_info, return_progress_data, reserve_info, titleName, submiting, show_foot, modal_width,
    ...
    return (
      <div className={global.common_page}
        ...
        >
          ...
          {
            (order_detail.orderState == 20 && order_detail.isLock == 0) &&
